                                    ...
                                    @foreach($bukus as $buku)
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <form action="{{ route('peminjamanstore.members') }}"
                                                        method="POST">
                                                        @csrf
                                                        ...
                                                        <input type="hidden" name="user_id"
                                                            value="{{ Auth::user()->id }}">
                                                        <button type="submit"
                                                            class="px-4 py-2 bg-blue-500 text-white rounded">Pinjam</button>
                                                    </form>
                                                @endif
...
<script>
    $(document).ready(function () {
        ...
        $('#kategoriSearch').on('keyup', function () {
            table
                .columns(5) // Kolom kategori berada di index 5
                .search(this.value) // Filter sesuai nilai input
                .draw();
        });
    });
