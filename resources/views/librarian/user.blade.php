    ...
    <div class="flex flex-col h-full">
        <div class="h-full sm:ml-64 p-4">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-800 dark:text-gray-400">Users</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <div class="mt-4 border-2 border-gray-200 bg-white rounded-lg dark:border-gray-700 p-6">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-300">Dashboard Sekuriti</h3>
                </div>
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6 space-y-6">
                                <form class="w-full" method="POST" action="{{ route('storeuser.librarian')}}">
                                    @csrf
                                    <div class="flex items-center justify-center h-24 rounded dark:bg-gray-800">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            id="name" name="name" type="text" placeholder="Masukkan user name" required>
                                    </div>
                                    <div class="mb-4">
                                        <label class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200"
                                            for="email">
                                        ...
                                        <input
                                            class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                                            id="email" name="email" placeholder="Masukkan Email" type="email"
                                            required></input>
                                    </div>
                                    <div class="mb-4">
                                        <label for="password"
                                            class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200">Password</label>
                                        <input type="password"
                                            class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                                    ...
                                    <div class="mb-4">
                                        <label for="password_confirmation"
                                            class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200">Password
                                            Confirmation</label>
                                        <input type="password"
                                            class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                            ...
                            <table id="myTable" class="min-w-full text-sm text-center text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr class="text-left text-white bg-gray-800">
                                        ...
                                        <th class="px-6 py-2 dark:text-gray-200">Email</th>
                                        <th class="px-6 py-2 dark:text-gray-200">Tipe User</th>
                                                ...
                                                <td class="px-6 py-3">
                                                    <div>
                                                        ...
                                                        <div id="edit-modal" tabindex="-1" aria-hidden="true"
                                                            ...
                                                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                                                <div
                                                                    ...
                                                                    <div class="p-6 space-y-6">
                                                                    <form id="edit-form" method="POST" action="{{ route('edituser.librarian', $user->id) }}">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <div class="mb-4">
                                                                            ...
                                                                            <input
                                                                                class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                                                                                id="edit-name" name="name" type="text" placeholder="Masukkan user name" required>
                                                                        </div>
                                                                        <div class="mb-4">
                                                                            <label class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200" for="email">
                                                                                Email
                                                                            </label>
                                                                            <input
                                                                                class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                                                                                id="edit-email" name="email" placeholder="Masukkan Email" type="email" required></input>
                                                                        </div>
                                                                        <div class="mb-4">
                                                                            <label for="password"
                                                                                class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200">Password</label>
                                                                        ...
                                                                        <div class="mb-4">
                                                                            <label class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200" for="role">
                                                                                Role User
                                                                            </label>
                                                                            <select id="edit-usertype" name="role"
                                                                                class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                                                                                required>
                                                                                <option value="librarian">Librarian</option>
                                                                                <option value="members">Members</option>
                                                        ...
                                                        <button type="button" data-modal-target="delete-modal"
                                                            ...
                                                            onclick="populateDeleteModal('{{ route('deleteuser.librarian', $user->id) }}')"
                                                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                                            title="Hapus">
...
<script>
    ...
    function populateEditModal(user) {
        document.getElementById('edit-form').action = `/librarian/user/edit/${user.id}`;

        document.getElementById('edit-name').value = user.name;
        document.getElementById('edit-email').value = user.email;
        document.getElementById('edit-usertype').value = user.role;
    }
