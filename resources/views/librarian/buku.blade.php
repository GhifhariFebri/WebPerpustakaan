                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6 space-y-6">
                                <form class="w-full" method="POST"
                                    action="{{ route('storebuku.librarian') }}">
                                    @csrf
                                    <div class="flex items-center justify-center h-24 rounded dark:bg-gray-800">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            id="nama" name="nama" type="text" placeholder="Masukkan nama buku"
                                            required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                                            id="penulis" name="penulis" type="text" placeholder="Masukkan penulis"
                                            required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                                            id="penerbit" name="penerbit" type="text" placeholder="Masukkan penerbit"
                                            required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                                            id="tanggal_terbit" name="tanggal_terbit" type="date" required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea
                                            class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                                            id="sinopsis" name="sinopsis" placeholder="Masukkan sinopsis buku"
                                            required></textarea>
                                    </div>

                                    <!-- Kategori Buku (Optional) -->
                                    <div class="mb-4">
                                        <label class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200"
                                            for="kategori">
                                            Kategori Buku
                                        ...
                                        <div class="space-y-2">
                                            @foreach($kategoris as $kategori)
                                                <div class="flex items-center">
                                                    <input type="checkbox" id="kategori_{{ $kategori->id }}"
                                                        name="categories[]" value="{{ $kategori->id }}"
                                                        class="shadow-sm text-blue-500 focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200">
                                                    <label for="kategori_{{ $kategori->id }}"
                                                        class="ml-2 text-gray-800 text-sm dark:text-gray-200">
                                                        {{ $kategori->nama }}
                                                    </label>
                                                </div>
                                            @endforeach
                ...
                <div class="grid grid-cols-1">
                    <div class="rounded dark:bg-gray-800">
                        <div class="overflow-x-auto w-full text-center">
                            <table id="myTable"
                                class="min-w-full text-sm text-center text-gray-500 dark:text-gray-400">
                                <thead
                                ...
                                <tbody>
                                    @foreach($bukus as $buku)
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-6 text-gray-800 font-semibold dark:text-gray-200">
                                                <div>
                                                    <button href="#" data-modal-target="edit-modal"
                                                        data-modal-toggle="edit-modal"
                                                        onclick="populateEditModal({{ $buku }})"
                                                    ...
                                                    <div id="edit-modal" tabindex="-1" aria-hidden="true"
                                                            ...
                                                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                                                ...
                                                                <div class="p-6 space-y-6">
                                                                    <form id="edit-form" method="POST" action="{{ route('editbuku.librarian', $buku->id) }}">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <div class="mb-4">
                                                                            <label class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200" for="edit-nama">Nama</label>
                                                                            <input id="edit-nama" name="nama" type="text" class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" value="{{ $buku->nama }}" required>
                                                                        </div>
                                                                        <div class="mb-4">
                                                                            <label class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200" for="edit-penulis">Penulis</label>
                                                                            <input id="edit-penulis" name="penulis" type="text" class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" value="{{ $buku->penulis }}" required>
                                                                        </div>
                                                                        <div class="mb-4">
                                                                            <label class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200" for="edit-penerbit">Penerbit</label>
                                                                            <input id="edit-penerbit" name="penerbit" type="text" class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" value="{{ $buku->penerbit }}" required>
                                                                        </div>

                                                                        <div class="mb-4">
                                                                            <label class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200" for="edit-tanggal_terbit">Tanggal Terbit</label>
                                                                            <input id="edit-tanggal_terbit" name="tanggal_terbit" type="date" class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" value="{{ $buku->tanggal_terbit }}" required>
                                                                        </div>
                                                                        <div class="mb-4">
                                                                            <label class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200" for="edit-sinopsis">Sinopsis</label>
                                                                            <textarea id="edit-sinopsis" name="sinopsis" class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-800 leading-tight focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" required>{{ $buku->sinopsis }}</textarea>
                                                                        </div>
                                                                        <div class="mb-4">
                                                                            <label class="block text-gray-800 text-sm font-bold mb-2 dark:text-gray-200"
                                                                                for="kategori">
                                                                            ...
                                                                            @foreach($kategoris as $kategori)
                                                                                <div class="flex items-center">
                                                                                    <input type="checkbox" id="edituntuk-kategori_{{ $kategori->id }}"
                                                                                        name="categories[]" value="{{ $kategori->id }}"
                                                                                        class="shadow-sm text-blue-500 focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200">
                                                                                    <label for="edituntuk-kategori_{{ $kategori->id }}"
                                                                                        class="ml-2 text-gray-800 text-sm dark:text-gray-200">
                                                                                        {{ $kategori->nama }}
                                                                                    </label>
                                                                                </div>
                                                                        ...
                                                                        <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                                                            <button class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" type="submit">Update</button>
                                                    ...
                                                    <button type="button" data-modal-target="delete-modal"
                                                        ...
                                                        onclick="populateDeleteModal('{{ route('deletebuku.librarian', $buku->id) }}')"
                                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                                        title="Hapus">
...
<script>
function populateEditModal(buku) {
    // Update form action URL
    document.getElementById('edit-form').action = `/librarian/buku/edit/${buku.id}`;

    document.getElementById('edit-nama').value = buku.nama;
    document.getElementById('edit-penulis').value = buku.penulis;
    document.getElementById('edit-penerbit').value = buku.penerbit;
    document.getElementById('edit-tanggal_terbit').value = buku.tanggal_terbit;
    document.getElementById('edit-sinopsis').value = buku.sinopsis;

    let categories = buku.categories.map(category => category.id);
console.log(categories);  // Cek apakah ID kategori benar
categories.forEach(categoryId => {
    let checkbox = document.getElementById(`edit-kategori_${categoryId}`);
    if (checkbox) {
        console.log(`Centang checkbox dengan ID: edit-kategori_${categoryId}`);  // Debugging
